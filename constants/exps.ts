...
export const experiences: IExperience[] = [
  {
    ...
    description: `Implment a form generator with dynamic fields and validations based on insurance policy and user data for an insurance company using formik.
